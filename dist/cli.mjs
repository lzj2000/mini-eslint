    ...
    var Command2 = class _Command extends EventEmitter2 {
      ...
      constructor(name) {
        ...
        this._outputConfiguration = {
          ...
          getOutHasColors: () => {
            var _a3, _b2;
            return useColor() ?? (process3.stdout.isTTY && ((_b2 = (_a3 = process3.stdout).hasColors) == null ? void 0 : _b2.call(_a3)));
          },
          getErrHasColors: () => {
            var _a3, _b2;
            return useColor() ?? (process3.stderr.isTTY && ((_b2 = (_a3 = process3.stderr).hasColors) == null ? void 0 : _b2.call(_a3)));
          },
...
-  already used by option '${matchingOption.flags}'`);
      ...
      _prepareUserArgs(argv, parseOptions) {
        ...
        if (argv === void 0 && parseOptions.from === void 0) {
          if ((_a3 = process3.versions) == null ? void 0 : _a3.electron) {
 ...
 - ${executableDirMessage}`;
      ...
      _dispatchHelpCommand(subcommandName) {
        ...
        return this._dispatchSubcommand(
          subcommandName,
          [],
          [((_a3 = this._getHelpOption()) == null ? void 0 : _a3.long) ?? ((_b2 = this._getHelpOption()) == null ? void 0 : _b2.short) ?? "--help"]
        );
      }
      /**
...
`);
      ...
      alias(alias) {
        ...
        const matchingCommand = (_a3 = this.parent) == null ? void 0 : _a3._findCommand(alias);
        if (matchingCommand) {
      ...
      outputHelp(contextOptions) {
        ...
        if ((_a3 = this._getHelpOption()) == null ? void 0 : _a3.long) {
  ...
  toRegExpSource(allowDot) {
    ...
    if (!this.type) {
      ...
      const src = __privateGet(this, _parts).map((p) => {
        var _a4;
        const [re, _, hasMagic2, uflag] = typeof p === "string" ? __privateMethod(_a4 = _AST, _AST_static, parseGlob_fn).call(_a4, p, __privateGet(this, _hasMagic), noEmpty) : p.toRegExpSource(allowDot);
...
var PathBase = class {
  ...
  async readlink() {
    ...
    try {
      ...
      const linkTarget = (_a3 = await this.parent.realpath()) == null ? void 0 : _a3.resolve(read);
      if (linkTarget) {
  ...
  readlinkSync() {
    ...
    try {
      ...
      const linkTarget = (_a3 = this.parent.realpathSync()) == null ? void 0 : _a3.resolve(read);
      if (linkTarget) {
        return __privateSet(this, _linkTarget, linkTarget);
      }
    } catch (er) {
...
var PathScurryBase = class {
  ...
  constructor(cwd = process.cwd(), pathImpl, sep2, { nocase, childrenCacheSize = 16 * 1024, fs: fs3 = defaultFS } = {}) {
    ...
    __privateSet(this, _fs2, fsFromOption(fs3));
...
var GlobUtil = class {
  ...
  matchCheckTest(e, ifDir) {
    var _a3;
    return e && (this.maxDepth === Infinity || e.depth() <= this.maxDepth) && (!ifDir || e.canReaddir()) && (!this.opts.nodir || !e.isDirectory()) && (!this.opts.nodir || !this.opts.follow || !e.isSymbolicLink() || !((_a3 = e.realpathCached()) == null ? void 0 : _a3.isDirectory())) && !__privateMethod(this, _GlobUtil_instances, ignored_fn).call(this, e) ? e : void 0;
  }
  ...
  matchFinish(e, absolute) {
    ...
    if (__privateMethod(this, _GlobUtil_instances, ignored_fn).call(this, e))
      return;
    if (!this.includeChildMatches && ((_a3 = __privateGet(this, _ignore)) == null ? void 0 : _a3.add)) {
...
ignored_fn = function(path4) {
  var _a3, _b2;
  return this.seen.has(path4) || !!((_b2 = (_a3 = __privateGet(this, _ignore)) == null ? void 0 : _a3.ignored) == null ? void 0 : _b2.call(_a3, path4));
};
childrenIgnored_fn = function(path4) {
  var _a3, _b2;
  return !!((_b2 = (_a3 = __privateGet(this, _ignore)) == null ? void 0 : _a3.childrenIgnored) == null ? void 0 : _b2.call(_a3, path4));
};
...
program2.argument(
  ...
  try {
    ...
    if (files.length === 0) {
      ...
      if (!fs2.existsSync(path3.join(process.cwd(), "src"))) {
        console.log(
